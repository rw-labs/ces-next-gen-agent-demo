...
OLLIE_CUSTOMER_FIRST_NAME = FIRST_NAME # Or "Alex"
OLLIE_CUSTOMER_LAST_NAME = LAST_NAME   # Or "Consumer"

DEFAULT_LANGUAGE = PROMPT_LANGUAGE or "en-US"
...
class OllieContext:
    ...
    CUSTOMER_PROFILE = {
        "customer_profile": {
            "first_name": OLLIE_CUSTOMER_FIRST_NAME,
            "last_name": OLLIE_CUSTOMER_LAST_NAME,
            "is_optus_customer": False, # Can be updated based on interaction
