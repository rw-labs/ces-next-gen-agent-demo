...
from .prompts import GenericPrompts# Will import OlliePrompts from prompts_R3.py
...
def create_generic_agent(
        ...
        name: str = "gemini_live_assistant",
        global_instructions: str = GenericPrompts.GLOBAL_PROMPT,
        instruction: str = GenericPrompts.GLOBAL_PROMPT,
    ...
    logger.info(f"Creating Generic agent '{name}' with {len(final_tools)} tools using model '{model_name}'.")
