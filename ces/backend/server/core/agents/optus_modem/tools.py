...
from .context import OptusModemContext # Imports LIVE_OPTUS_CATALOG_DATA
...
def greeting() -> dict:
    ...
    return {"greeting_message": f"Hello! I'm your Optus Modem Setup Assistant. How can I help you today?"}
...
def search_live_optus_catalog(search_term: str, tool_context: ToolContext) -> dict:
    ...
    catalog_data = OptusModemContext.LIVE_OPTUS_CATALOG_DATA
    if not catalog_data:
