# ./server/core/agents/xtelcom/examples.py

class XtelcomExamples:
    # Using __ASSISTANT_NAME__ and __BRAND_NAME__ as placeholders,
    # will be replaced by values from XtelcomContext in prompts.py
...
<Example>
[USER]:
I'm thinking of upgrading my phone. What new Android phones does Xtelcom have?
...
print(search_xtelcom_android_catalog(search_criteria='Samsung great camera'))
IGNORE_WHEN_COPYING_START
content_copy
download
Use code with caution.
...
Would you like to know more about either of these, or perhaps see other options? You can find more details on the S24 Ultra here: https://www.xtelcom.com.au/mobile-phones//samsung/galaxy-s24-ultra
...
<Example>
[USER]:
That's all the help I needed, thank you Telly!
